...
class Inputs:
    ...
    network_path = "C:/Users/shiva/Desktop/r/data"
    network_name = "nsf_14_network.json"
    chains_path = "C:/Users/shiva/Desktop/r/data"
    chains_name = "nsf_14_network.json"
    chains_random_name = "chain_random.json"
    chains_random_path = "C:/Users/shiva/Desktop/r/data"
    ...
    batch_Size = 4
    node_features = 4
    learning_rate = 1e-7  # one e power -7 = 9.11*10^-4
